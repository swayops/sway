...
<div>
	...
	<p style="font-size:14px; color:#000000; margin:0;">Please click the link below to reset your password, the link will be valid for 24 hours.<br><a href="{{ URL }}">{{ URL }}</a></p><br/>
	<p style="font-size:14px; color:#000000; margin:0;">If this request was not intended, please disregard this message.</a></p><br/>
