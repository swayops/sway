...
const notifySubmissionEmail = `
<div>
	<p style="font-size:14px; color:#000000; margin:0 0 12px 0;">
		Hi {{Name}},
	</p>
	<p style="font-size:14px; color:#000000; margin:0 0 12px 0;">
		I am emailing to let you know that {{InfluencerName}} has just submitted a post that's awaiting your approval for campaign {{CampaignName}} .
	</p>

	<p style="font-size:14px; color:#000000; margin:0 0 12px 0;">
		Prompt approval or request for changes on the submitted post ensures early delivery! Let me know if you have any questions
	</p>
	<p style="font-size:14px; color:#000000; margin:0 0 12px 0;">
		Regards,<br/>
		~ Karlie M<br/>
